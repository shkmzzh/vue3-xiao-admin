...
import FoldChart from "./components/FoldChart.vue";
...
<template>
  <div class="dashboard-container">
        ...
        <el-col :span="18" :xs="24">
          <div class="flex h-full items-center">
            <img
              ...
              :src="'https://avatars.githubusercontent.com/u/87223862?v=4'"
            />
            <div>
              <p>{{ greetings }}</p>
    ...
    <el-row :gutter="10" class="mt-3">
        ...
        <el-card shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-[var(--el-text-color-secondary)]">即将入库（票）</span>
      ...
      <el-col :xs="24" :sm="12" :lg="4">
        <el-card shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-[var(--el-text-color-secondary)]">尚未出库-一件（票）</span>
              <el-tag type="success">日</el-tag>
            </div>
          </template>
      ...
      <el-col :xs="24" :sm="12" :lg="4">
        <el-card shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-[var(--el-text-color-secondary)]">尚未出库-整批（票）</span>
              <el-tag type="success">日</el-tag>
            </div>
          </template>
      ...
      <el-col :xs="24" :sm="12" :lg="4">
        <el-card shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-[var(--el-text-color-secondary)]">昨日出库-一件（票）</span>
              <el-tag type="success">日</el-tag>
            </div>
          </template>
      ...
      <el-col :xs="24" :sm="12" :lg="4">
        <el-card shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-[var(--el-text-color-secondary)]">昨日出库-整批（票）</span>
              <el-tag>月</el-tag>
            </div>
          </template>
      ...
      <el-col :xs="24" :sm="12" :lg="4">
        <el-card shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-[var(--el-text-color-secondary)]">仓库可用空间（估算）</span>
    ...
    <el-row :gutter="10" class="mt-3">
      <el-col :sm="24" :lg="24">
        <FoldChart  id="foldChart"
          height="500px"
          width="100%"
          class="bg-[var(--el-bg-color-overlay)]"></FoldChart>
      </el-col>
